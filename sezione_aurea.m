...
% 
% [xVect, iter, errStima] = sezione_aurea(f, a, b, toll, nmax)
% 
...
% toll   tolleranza criterio d'arresto basato su stimatore dell'errore
% nmax   numero massimo di iterazioni ammesse
%
% Parametri di uscita:
% xVect     vettore delle approssimazioni x_k del punto di minimo 
% iter      numero di iterazioni eseguite
% errStima  vettore delle stime dell'errore e_k
%
%                                         Politecnico di Milano, 03/04/2025
% 
% errore al passo k come e_k <= abs(b-a)/(phi^k * 2)
% phi = (1 + sqrt(5)) / 2
% 
% [xVect, iter, errStima] = sezione_aurea(f, a, b, toll, nmax)
% 
