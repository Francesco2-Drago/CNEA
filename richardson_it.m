...
%
% [xVect, iter] = richardson_it(A, b, P, x0, toll, nmax, alpha)
%
...
%
% Parametri di uscita:
% xVect     Matrice contenente tutte le iterate (vettori approssimanti x)
%           xk = [ x0, x1, x2, ... ] dimensione ( n x ( k + 1 ) )      
% iter      Numero di iterazioni effettuate
%
%                                         Politecnico di Milano, 04/04/2024
% 
% Senza alpha (1 input in meno) ho alpha dinamico e quindi metodo del
% gradiente !!!
%
% [xVect, iter] = richardson_it(A, b, P, x0, toll, nmax, alpha)
% 
