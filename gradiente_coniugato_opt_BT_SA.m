...
%
% [xVect, iter] = gradiente_coniugato_opt_BT_SA(Phi, GradPhi, flag_metodo, flag_alpha, x0, toll, nmax)
%
...
% iter          (int) numero di iterazioni
%
%                                         Politecnico di Milano, 03/04/2025
% 
% Ordini di convergenza:
% Gradiente: <= 1 (linearmente al più)
% Gradiente coniugato: >= 1 (linarmente o superlinearmente)
%
% [xVect, iter] = gradiente_coniugato_opt_BT_SA(Phi, GradPhi, flag_metodo, flag_alpha, x0, toll, nmax)
% 
